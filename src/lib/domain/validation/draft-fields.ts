...
/**
 * The editor grows a thread on demand and has no ceiling of its own, so this
 * is a sanity bound rather than a product limit: far above any thread a person
 * would write, low enough to bound what a single request can store.
 */
export const MAX_THREAD_SEGMENTS = 500;
