<script lang="ts">
	...
	function applyRelativeReschedule() {
		let d = '0',
			h = '0',
			m = '0';
		if (rescheduleRelativeUnit === 'days') d = rescheduleRelativeValue;
		if (rescheduleRelativeUnit === 'hours') h = rescheduleRelativeValue;
		if (rescheduleRelativeUnit === 'mins') m = rescheduleRelativeValue;
